...
class MalariaModel(pl.LightningModule):
    def __init__(self, num_classes=3):
        ...
        self.fc1 = nn.Linear(128 * 12 * 12, 512)  # Ajusta el tamaño según el tamaño de tus imágenes después del pooling
    ...
    def forward(self, x):
        ...
        out = self.layer2(out)
        out = self.layer3(out)
        out = out.view(out.size(0), -1)  # Aplanar el tensor para la capa completamente conectada
    ...
    def on_fit_end(self):
        ...
        plt.ylabel('Loss')
        plt.legend()
        plt.savefig('figures/2/Graph.png')  
        plt.close()  
    ...
    def show_confusion_matrix(self, predictions, labels, name):
        ...
        plt.savefig(f'figures/2/{name}_confusion_matrix.png')
        plt.close()
